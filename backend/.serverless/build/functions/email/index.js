// services/email/sendReminderEmail.ts
import { SESv2Client, SendEmailCommand } from "@aws-sdk/client-sesv2";
var ses = new SESv2Client({
  region: process.env.AWS_REGION
});
var sendReminderEmail = async (to, title) => {
  const command = new SendEmailCommand({
    ...
    Content: {
      Simple: {
        Subject: {
          Data: "Reminder om din ans\xF6kan"
        },
        Body: {
          Text: {
            Data: `Hej! Detta \xE4r en reminder f\xF6r din ans\xF6kan: ${title}`
          }
        }
      }
    }
...
var handler = core_default(sendEmail);
export {
  handler,
  sendEmail
};
