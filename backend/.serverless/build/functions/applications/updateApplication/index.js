...
// middlewares/schemas/updateApplicationSchema.ts
...
// functions/applications/updateApplication/index.ts
...
var updateApplication = async (event) => {
...
var handler = core_default(updateApplication).use(http_json_body_parser_default()).use(validator_default({ eventSchema: transpileSchema(updateApplicationSchema) })).use(checkAuth()).onError((request) => {
